...
- `TajsCoreRuntime` (`res://mods-unpacked/TajemnikTV-Core/core/runtime.gd`) - singleton entrypoint (`Engine.get_meta("TajsCore")`).
- `TajsCoreSettings` (`res://mods-unpacked/TajemnikTV-Core/core/settings.gd`) - schema-backed settings and typed getters.
- `TajsCoreEventBus` (`res://mods-unpacked/TajemnikTV-Core/core/event_bus.gd`) - cross-mod events and sticky payloads.
- `TajsCoreCommandRegistry` (`res://mods-unpacked/TajemnikTV-Core/core/commands/command_registry.gd`) - register/execute command palette actions.
- `TajsCoreDiagnostics` (`res://mods-unpacked/TajemnikTV-Core/core/diagnostics.gd`) - support dumps, JSON export, clipboard copy.
- `TajsCoreIconRegistry` (`res://mods-unpacked/TajemnikTV-Core/core/icon_registry.gd`) - icon indexing for picker/browser flows.
- `TajsCoreModuleRegistry` (`res://mods-unpacked/TajemnikTV-Core/core/module_registry.gd`) - module metadata and min-core gating.
- `TajsCoreUiManager` (`res://mods-unpacked/TajemnikTV-Core/core/ui/ui_manager.gd`) - settings tabs, HUD injection, popups, icon browser.
